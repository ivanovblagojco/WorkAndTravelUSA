    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ClientLocs", t => t.ClientLoc_Id)
                .Index(t => t.ClientLoc_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Comments", "Location_Id", "dbo.Locations");
            ...
            DropIndex("dbo.Comments", new[] { "Location_Id" });
